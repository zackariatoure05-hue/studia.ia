...
const AnimatedRecording = () => {
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      {/* Ripple effects */}
      <div
        className="absolute w-32 h-32 bg-blue-500/20 rounded-full animate-ping"
        style={{ animationDuration: "3s" }}
      />
      <div
        className="absolute w-48 h-48 bg-cyan-500/10 rounded-full animate-ping"
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center perspective-[1000px]">
      ...
      >
        ...
        {/* Back */}
        <div
          className="absolute inset-0 backface-hidden bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl shadow-xl p-8 flex flex-col justify-center items-center text-center text-white"
          style={{ transform: "rotateY(180deg)" }}
        >
          <CheckCircle2 className="w-10 h-10 text-white/80 mb-6" />
          <p className="font-semibold text-white/90">
            Processus de division cellulaire produisant deux cellules filles identiques.
          </p>
        </div>
      </div>
      <style jsx>{`
        ...
        <div className="flex-1 p-4 flex flex-col items-center justify-center gap-6 relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-[dropIn_1s_ease-out_forwards]">
            <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-lg flex items-center justify-center relative">
              ...
              {/* Notification badge */}
              <div
                className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full animate-bounce"
...
const STEPS = [
  {
    ...
    description:
      "Bienvenue dans StudIA. Voici comment nous allons transformer tes heures de cours en véritables fiches de révision, sans aucun effort.",
  ...
  },
  {
    ...
    description:
      "En amphi ou en TD, lance simplement un nouvel enregistrement. L'IA écoute et transcrit tout en direct avec une précision chirurgicale.",
  ...
  },
  {
    ...
    description:
      "Dès que le cours est terminé, l'IA analyse la transcription pour te générer un résumé structuré et des flashcards pour réviser activement.",
  ...
  },
  {
    ...
    description:
      "Pour avoir StudIA toujours dans ta poche : appuie sur le bouton « Partager » de ton navigateur (Safari/Chrome), puis choisis « Sur l'écran d'accueil ».",
      ...
      <div className="w-full max-w-4xl bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/50 flex flex-col min-h-[600px] relative z-10">
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className="p-8 lg:p-12 lg:w-1/2 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-slate-100 relative">
            ...
            <div className="mt-16">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-slate-900 mb-6 tracking-tight animate-in slide-in-from-left-8 duration-700 fade-in">
                {currentStep === 0 && user?.prenom ? `Salut ${user.prenom} ! ` : ""}
                {step.title}
              </h1>
          ...
          <div className="lg:w-1/2 p-8 lg:p-12 flex items-center justify-center bg-slate-50/50 relative overflow-hidden min-h-[350px]">
            ...
            <div
              key={currentStep}
              className="w-full h-full flex items-center justify-center animate-in zoom-in-95 duration-500 fade-in"
            >
              {step.component}
            </div>
          </div>
