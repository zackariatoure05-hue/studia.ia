...
export default function AbonnementPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ textAlign: "center", marginBottom: "3rem", animation: "fadeIn 0.5s ease-out" }}
        >
          {isExpired ? (
            <div
              style={{
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: isSelected
                    ? `0 10px 40px -10px ${plan.color}40`
                ...
                <div style={{ flex: 1 }}>
                  {plan.features.map((feature, i) => (
                    ...
                    >
                      <Check
                        size={18}
                        style={{ color: plan.color, flexShrink: 0, marginTop: "2px" }}
                      />
        ...
        <div style={{ marginTop: "4rem", textAlign: "center" }}>
          ...
          >
            {loading ? "Traitement du paiement..." : "Confirmer mon abonnement"}
          </button>
