...
import { Mic, BrainCircuit, Folders, Bot, Sparkles, CheckCircle2, ChevronRight, Zap, Target, BookOpen, Clock, Users } from "lucide-react";
      ...
      <header className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200/50 transition-all">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link href="#fonctionnalites" className="text-sm font-semibold text-slate-600 hover:text-indigo-600 transition-colors">
              Fonctionnalités
            </Link>
            <Link href="#histoire" className="text-sm font-semibold text-slate-600 hover:text-indigo-600 transition-colors">
              Notre Histoire
            </Link>
            <Link href="#tarifs" className="text-sm font-semibold text-slate-600 hover:text-indigo-600 transition-colors">
              Tarifs
            </Link>
          </nav>
          
          <div className="flex items-center gap-4">
            <Link href="/connexion" className="text-sm font-bold text-slate-700 hover:text-indigo-600 transition-colors hidden sm:block">
              Connexion
            </Link>
            <Link href="/inscription" className="bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-bold hover:bg-slate-800 hover:scale-105 transition-all shadow-xl shadow-slate-900/20 flex items-center gap-2">
      ...
      <main className="flex-1 pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-left z-10 relative">
                ...
                <p className="text-lg md:text-xl text-slate-600 mb-10 leading-relaxed animate-in slide-in-from-left-8 fade-in duration-700 delay-200">
                  L'IA qui enregistre tes cours, les transcrit en direct, et génère tes résumés et flashcards instantanément. Divise ton temps de révision par deux.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 animate-in slide-in-from-left-10 fade-in duration-700 delay-300">
                  <Link href="/inscription" className="bg-indigo-600 text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-indigo-700 hover:scale-105 hover:shadow-indigo-600/40 transition-all shadow-xl shadow-indigo-600/30 flex items-center gap-2 w-full sm:w-auto justify-center">
                    Commencer maintenant <ChevronRight className="w-5 h-5" />
                  </Link>
                  <Link href="#fonctionnalites" className="bg-white text-slate-700 border border-slate-200 px-8 py-4 rounded-full text-lg font-bold hover:bg-slate-50 transition-colors w-full sm:w-auto justify-center flex items-center">
                    Découvrir comment
                  </Link>
                </div>
              </div>
              ...
              <div className="relative animate-in zoom-in-95 fade-in duration-1000 delay-500 lg:h-[600px] flex items-center justify-center">
                ...
                <div className="absolute top-10 right-10 w-24 h-24 bg-gradient-to-br from-pink-400 to-purple-500 rounded-3xl opacity-50 blur-2xl animate-bounce" style={{ animationDuration: '4s' }}></div>
                <div className="absolute bottom-10 left-10 w-32 h-32 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full opacity-50 blur-2xl animate-bounce" style={{ animationDuration: '6s', animationDelay: '1s' }}></div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-3 gap-12 text-center">
              <div className="space-y-4">
                ...
                <p className="text-slate-600 leading-relaxed">Fini les heures à recopier tes notes au propre. Sors de cours avec tes fiches déjà prêtes.</p>
              </div>
              <div className="space-y-4">
                ...
                <p className="text-slate-600 leading-relaxed">Écoute activement ton prof et participe. Laisse notre IA s'occuper de la prise de notes exhaustive.</p>
              </div>
              <div className="space-y-4">
                ...
                <p className="text-slate-600 leading-relaxed">Révise activement grâce aux flashcards générées sur mesure, basées sur la science de la répétition espacée.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="fonctionnalites" className="py-32 px-6 bg-slate-50 relative">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">Le couteau suisse de l'étudiant</h2>
              <p className="text-xl text-slate-600">Tout ce dont tu as besoin pour exceller, réuni dans une seule application pensée pour ta réussite.</p>
            </div>
              ...
              <div className="order-2 lg:order-1 space-y-12">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-lg leading-relaxed">Pose ton téléphone sur la table. L'IA écoute et retranscrit le cours en temps réel, même au fond de l'amphi.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-2">Résumés de niveau Master</h3>
                    <p className="text-slate-600 text-lg leading-relaxed">Notre IA ne fait pas que résumer. Elle analyse, structure et enrichit ton cours avec du contexte additionnel.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-2">Avatar IA Pédagogique</h3>
                    <p className="text-slate-600 text-lg leading-relaxed">Choisis ton prof virtuel. Pose-lui des questions sur tes cours obscurs, il te répondra avec pédagogie.</p>
                  </div>
                </div>
              </div>
        ...
        <section id="histoire" className="py-24 bg-slate-900 text-white px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-8">Créé par des étudiants, pour les étudiants</h2>
            <p className="text-xl text-slate-300 leading-relaxed mb-8">
              "L'idée de StudIA est née d'une frustration simple : passer plus de temps à recopier des notes qu'à réellement comprendre le cours. Nous avons voulu créer l'outil ultime que nous aurions rêvé d'avoir en première année de fac."
            </p>
        ...
        <section id="tarifs" className="py-32 px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">Investis dans ta réussite</h2>
              <p className="text-xl text-slate-600">Des tarifs transparents, adaptés au budget étudiant. Sans engagement.</p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
              {plans.map((plan, i) => (
                <div key={i} className={`relative bg-white rounded-3xl p-8 border ${plan.highlighted ? 'border-indigo-500 shadow-2xl shadow-indigo-500/20 scale-105 z-10' : 'border-slate-200 shadow-lg'} flex flex-col h-full transition-transform`}>
                  {plan.badge && (
                  ...
                  <Link href="/inscription" className={`w-full py-4 rounded-xl font-bold text-center transition-all ${plan.highlighted ? 'bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg shadow-indigo-600/30 hover:shadow-indigo-600/50 hover:-translate-y-1' : 'bg-slate-100 text-slate-900 hover:bg-slate-200'}`}>
                    {plan.cta}
                  </Link>
                </div>
              ))}
        ...
        <section className="py-32 px-6 bg-white text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-8">Prêt à valider ton semestre ?</h2>
            <p className="text-xl text-slate-600 mb-10">Rejoins StudIA aujourd'hui et découvre une nouvelle façon d'étudier, sans stress.</p>
            <Link href="/inscription" className="inline-flex bg-slate-900 text-white px-10 py-5 rounded-full text-xl font-bold hover:bg-slate-800 hover:scale-105 transition-all shadow-2xl shadow-slate-900/30 items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6 inline-flex">
              ...
              <span className="font-extrabold text-2xl text-white">Studi<span className="text-indigo-400">IA</span></span>
            </Link>
            <p className="text-slate-400 max-w-sm leading-relaxed">
              L'IA qui transforme tes cours en résumés et flashcards. Révise mieux, retiens plus. Conçu pour la réussite de tous les étudiants.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/politique-de-confidentialite" className="text-slate-400 hover:text-indigo-400 transition-colors">Politique de confidentialité</Link></li>
              <li><Link href="/cookies" className="text-slate-400 hover:text-indigo-400 transition-colors">Politique des cookies</Link></li>
              <li><Link href="/mentions-legales" className="text-slate-400 hover:text-indigo-400 transition-colors">Mentions légales</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="mailto:contact@studia.app" className="text-slate-400 hover:text-indigo-400 transition-colors">contact@studia.app</a></li>
