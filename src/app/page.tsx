            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="text-left z-10 relative">
                ...
                <div className="flex flex-row items-center justify-center sm:justify-start gap-3 sm:gap-4 flex-wrap">
                  ...
                  >
                    Commencer <ChevronRight className="w-3.5 h-3.5 sm:w-5 sm:h-5 shrink-0" />
                  </Link>
                  <Link
                    href="#fonctionnalites"
                    className="bg-white text-slate-700 border border-slate-200 px-4 py-2.5 sm:px-6 sm:py-3.5 rounded-full text-xs sm:text-sm md:text-base font-bold hover:bg-slate-50 transition-colors flex items-center"
                  >
                    Découvrir comment
                  </Link>
                </div>
