  ...
  return (
    <>
      ...
      <div style={SECTION_STYLE}>
        ...
        >
          ...
          <div>
            ...
            >
              Changer de faculté mettra à jour votre tableau de bord principal.
            </p>
          </div>
      ...
      <div style={SECTION_STYLE}>
        ...
        {[
          {
            label: "Rappels de révision quotidiens",
            desc: "Reçois un e-mail de rappel chaque matin",
          },
          { label: "Nouveaux résumés générés", desc: "Notification quand un résumé IA est prêt" },
          {
            label: "Mises à jour de la plateforme",
            desc: "Sois informé des nouvelles fonctionnalités",
          },
        ].map((item, i) => (
          <div
            key={i}
      ...
      <div style={{ ...SECTION_STYLE, border: "1px solid #fecaca" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
          ...
          <button
            onClick={() => {
              if (confirm("Supprimer votre compte ?")) logout();
            }}
            style={{
              padding: "0.6rem 1.25rem",
