...
import { MapPin, User as UserIcon, Calendar, GraduationCap, ChevronRight, CheckCircle2, Sparkles, BrainCircuit } from "lucide-react";

const AVATARS = [
  { id: "socrates", name: "Le Professeur Socrate", desc: "Philosophique, vous fait trouver la réponse par vous-même.", icon: "🏛️" },
  { id: "einstein", name: "Le Génie Structuré", desc: "Clair, précis, axé sur la logique et la mémorisation.", icon: "🧠" },
  { id: "chill", name: "L'Étudiant Chill", desc: "Te parle comme un pote, utilise des exemples simples et fun.", icon: "🤙" },
  { id: "mentor", name: "Le Mentor Motivateur", desc: "Ne te lâche jamais, toujours là pour te booster avant les partiels.", icon: "🔥" },
];
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <div style={{
            width: 56, height: 56, borderRadius: 16, background: "oklch(0.96 0.02 276)",
          ...
          <h1 style={{ fontSize: "1.8rem", fontWeight: 800, color: "#0f172a", margin: "0 0 0.5rem" }}>
        ...
        {step === 1 && (
          <div className="animate-page-enter">
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
              <div>
                <label style={{ display: "block", fontSize: "0.85rem", fontWeight: 600, color: "#475569", marginBottom: "0.5rem" }}>Prénom</label>
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    placeholder="Camille"
                    style={{ width: "100%", padding: "0.8rem 0.8rem 0.8rem 2.5rem", borderRadius: 12, border: "1px solid #cbd5e1", fontSize: "0.95rem" }}
                  />
                </div>
              </div>
              <div>
                <label style={{ display: "block", fontSize: "0.85rem", fontWeight: 600, color: "#475569", marginBottom: "0.5rem" }}>Nom</label>
                <input
                  type="text" value={nom} onChange={(e) => setNom(e.target.value)}
                  placeholder="Dupont"
                  style={{ width: "100%", padding: "0.8rem", borderRadius: 12, border: "1px solid #cbd5e1", fontSize: "0.95rem" }}
                />
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "1rem", marginBottom: "2rem" }}>
              <div>
                <label style={{ display: "block", fontSize: "0.85rem", fontWeight: 600, color: "#475569", marginBottom: "0.5rem" }}>Âge</label>
                <div style={{ position: "relative" }}>
              ...
              <div>
                <label style={{ display: "block", fontSize: "0.85rem", fontWeight: 600, color: "#475569", marginBottom: "0.5rem" }}>Ville d'étude</label>
                <div style={{ position: "relative" }}>
            ...
            <button
              ...
              style={{
                ...
                border: "none", borderRadius: 999, fontWeight: 700, fontSize: "1rem",
        ...
        {step === 2 && (
          <div className="animate-page-enter">
            <div style={{ display: "grid", gap: "0.75rem", marginBottom: "1.5rem", maxHeight: 200, overflowY: "auto", paddingRight: "0.5rem" }}>
              {facultes.map((fac) => (
                <button
                  key={fac.id}
                  onClick={() => {
                  ...
                  style={{
                    ...
                    borderRadius: 16, fontWeight: 600, cursor: "pointer", transition: "all 0.2s",
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <input
                type="text" value={newFaculteName}
                onChange={(e) => {
        ...
        {step === 3 && (
          <div className="animate-page-enter">
            <div style={{ display: "grid", gap: "1rem", marginBottom: "2.5rem" }}>
              {AVATARS.map((avatar) => (
                ...
                >
                  ...
                  <div>
                    <h3 style={{ margin: "0 0 0.2rem", fontSize: "1rem", fontWeight: 700, color: avatarId === avatar.id ? "var(--primary)" : "#0f172a" }}>
                      {avatar.name}
                    </h3>
                  ...
                  {avatarId === avatar.id && <Sparkles className="w-5 h-5 text-primary ml-auto flex-shrink-0" />}
                </button>
              ))}
            </div>
            ...
            <button
              ...
              style={{
                width: "100%", padding: "1rem", background: "linear-gradient(135deg, oklch(0.6 0.15 276), oklch(0.5 0.25 290))", color: "#fff",
                border: "none", borderRadius: 999, fontWeight: 700, fontSize: "1.1rem",
                cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem",
