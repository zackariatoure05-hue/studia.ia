        ...
        <div className="space-y-6 text-slate-700 leading-relaxed">
          <section>
            ...
            <p>
              ...
              <strong>Jean Dupont</strong> (à modifier)<br />
              Statut : Entrepreneur individuel (Auto-entrepreneur)<br />
              Adresse : 1 Rue de la Paix, 75000 Paris, France (à modifier)<br />
          ...
          <section>
            ...
            <p>
              ...
              Par email : <strong>contact@studia.app</strong><br />
          ...
          <section>
            ...
            <p>
              ...
              Site internet : <a href="https://vercel.com" className="text-primary hover:underline">vercel.com</a>
            </p>
          </section>
