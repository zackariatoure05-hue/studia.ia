...
export function ErrorDisplay({ 
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: "oklch(0.97 0.02 27)", color: "var(--destructive)",
        padding: "1rem", borderRadius: "50%", marginBottom: "1.5rem"
      }}>
        <AlertTriangle size={32} />
      </div>
      <h2 style={{ fontSize: "1.25rem", fontWeight: 700, margin: "0 0 0.75rem", color: "var(--foreground)" }}>
        Oups, un problème est survenu
      </h2>
      <p style={{ color: "var(--muted-foreground)", margin: "0 0 2rem", maxWidth: "400px", lineHeight: 1.5 }}>
        {message}
      </p>
      {onRetry && (
        <button
