...
export default function Topbar() {
  ...
  const { isRecording, isPaused, recordingTime, stopRecording, pauseRecording, resumeRecording } =
    useRecording();
          ...
          >
            ...
            <span
              style={{
                fontSize: "0.8rem",
                fontWeight: 700,
                color: isPaused ? "oklch(0.4 0 0)" : "oklch(0.5 0.2 27)",
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderBottom: "1px solid var(--border)",
                  background: "oklch(0.99 0.01 276)",
                }}
              >
